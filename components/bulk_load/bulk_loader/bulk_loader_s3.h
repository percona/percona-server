...
#include "components/bulk_load/data_stream/stream_s3/data_stream_s3.h"

namespace Bulk_load {

template <>
class Bulk_loader_base<Bulk_source::S3> : public Bulk_loader_impl {
 public:
...
using Bulk_loader_s3 = Bulk_loader_base<Bulk_source::S3>;
