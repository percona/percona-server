...
TextRow::TextRow(size_t num_columns)
    : m_is_last_row{false},
...
void TextRow::set_column(char *column_begin, const char *column_end) noexcept {
...
bool TextRow::process_columns(Rows_text &text_rows) noexcept {
  size_t column_idx = 0;
...
void TextRow::reset() noexcept {
  m_column_idx = 0;
}

bool TextRow::check_full() const noexcept {
