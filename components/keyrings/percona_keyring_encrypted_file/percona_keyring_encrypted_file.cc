...
/* clang-format off */
/**
  @page PAGE_COMPONENT_PERCONA_KEYRING_ENCRYPTED_FILE component_percona_keyring_encrypted_file

  This is keyring component services' implementation with encrypted file as backend to
  ...
  For most parts, component_percona_keyring_encrypted_file relies on keyring_common library
  for implementation.

  The component relies on component_percona_keyring_encrypted_file.cnf file for configuration.

  Location of this configuration file is same directory where component_percona_keyring_encrypted_file
  ...
  component_percona_keyring_encrypted_file.cnf and expected format is 2.
...
bool init_or_reinit_keyring(std::string &err) {
  ...
  if (percona_keyring_encrypted_file::config::find_and_read_config_file(
          new_config_pod, err))
    return true;
  ...
  std::unique_ptr<Keyring_encrypted_file_backend> new_backend =
      std::make_unique<Keyring_encrypted_file_backend>(
          ...
          new_config_pod.get()->read_only_, new_config_pod.get()->password_,
          new_config_pod.get()->iterations_);
  ...
  Keyring_operations<Keyring_encrypted_file_backend> *new_operations =
...
*/
static mysql_service_status_t keyring_encrypted_file_init() {
...
*/
static mysql_service_status_t keyring_encrypted_file_deinit() {
...
KEYRING_AES_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_GENERATOR_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_LOAD_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_KEYS_METADATA_FORWARD_ITERATOR_IMPLEMENTOR(
    component_percona_keyring_encrypted_file);
KEYRING_COMPONENT_STATUS_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_COMPONENT_METADATA_QUERY_IMPLEMENTOR(
    component_percona_keyring_encrypted_file);
KEYRING_READER_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_WRITER_IMPLEMENTOR(component_percona_keyring_encrypted_file);
/* Used if log_builtins is not available */
KEYRING_LOG_BUILTINS_IMPLEMENTOR(component_percona_keyring_encrypted_file);
KEYRING_LOG_BUILTINS_STRING_IMPLEMENTOR(
    component_percona_keyring_encrypted_file);

/** Component provides */
BEGIN_COMPONENT_PROVIDES(component_percona_keyring_encrypted_file)
PROVIDES_SERVICE(component_percona_keyring_encrypted_file, keyring_aes),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file,
                     keyring_generator),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file, keyring_load),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file,
                     keyring_keys_metadata_iterator),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file,
                     keyring_component_status),
    ...
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file, keyring_writer),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file, log_builtins),
    PROVIDES_SERVICE(component_percona_keyring_encrypted_file,
                     log_builtins_string),
...
BEGIN_COMPONENT_METADATA(component_percona_keyring_encrypted_file)
...
DECLARE_COMPONENT(component_percona_keyring_encrypted_file,
                  "component_percona_keyring_encrypted_file")
percona_keyring_encrypted_file::keyring_encrypted_file_init,
    percona_keyring_encrypted_file::keyring_encrypted_file_deinit
    END_DECLARE_COMPONENT();

/** Component contained in this library */
DECLARE_LIBRARY_COMPONENTS &COMPONENT_REF(
    component_percona_keyring_encrypted_file) END_DECLARE_LIBRARY_COMPONENTS
