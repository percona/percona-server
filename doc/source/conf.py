...
html_title = 'Percona Server 5.1 Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Percona Server 5.1'
...
htmlhelp_basename = 'PerconaServer51doc'
...
intersphinx_mapping = {
    'ps55' : ('http://www.percona.com/doc/percona-server/5.5/', 
              'ps55-inv.txt'),
    'xtrabackup' : ('http://www.percona.com/doc/percona-xtrabackup',
                    'xbk-inv.txt'),
    'ptoolkit' : ('http://www.percona.com/doc/percona-toolkit',
                  'ptoolkit-inv.txt'),
 }
