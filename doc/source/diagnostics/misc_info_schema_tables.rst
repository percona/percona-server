...
.. table:: INFORMATION_SCHEMA.INNODB_BUFFER_POOL_PAGES
  ...
  :column SPACE_ID: The id of the table in the tablespace containing it
  :column PAGE_NO:  page number in the buffer pool of the page (position of the page)
  :column LRU_POSITION:	LRU clock of the block
  :column FIX_COUNT: how many in use
...
.. table:: INFORMATION_SCHEMA.INNODB_BUFFER_POOL_PAGES_INDEX
  ...
  :column space_id: space id of the page (position of the page)
  :column page_no: page number of the page (position of the page)
  ...
  :column access_time: used (1) or not (0)
