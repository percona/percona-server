...
|Percona Server| has implemented compression support for :command:`mysqlbinlog`
in :rn:`5.6.15-63.0`. This is similar to support that both ``mysql`` and
...
============================
  ...
  * :rn:`5.6.15-63.0`
    :command:`mysqlbinlog` now has all SSL connection options as the rest of
