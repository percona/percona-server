...
This page provides the information on how you can install **Percona Server for MySQL**.

The following options are available:

* :ref:`installing_from_binaries` (recommended)
* Installing **Percona Server for MySQL** from Downloaded :ref:`rpm <standalone_rpm>` or :ref:`apt <standalone_deb>` Packages
...
Percona provides repositories for :program:`yum` (``RPM`` packages for *Red Hat*, *CentOS* and *Amazon Linux AMI*) and :program:`apt` (:file:`.deb` packages for *Ubuntu* and *Debian*) for software such as **Percona Server for MySQL**, **Percona XtraBackup**, and *Percona Toolkit*. This makes it easy to install and update your software and its dependencies through your operating system's package manager. This is the recommended way of installing where possible.
...
In **Percona Server for MySQL** 5.7.31-34 and later, the multiple binary tarballs have been replaced with the following:
