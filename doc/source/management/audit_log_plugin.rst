...
In :rn:`5.6.32-78.0` |Percona Server| has implemented filtering by user. This
...
Account names are the ones that are logged in the audit log. For example when
you create a user:
...
To exclude ``user1`` from logging in |Percona Server| 5.6 you must set:
...
In :rn:`5.6.32-78.0` |Percona Server| has implemented filtering by SQL command
