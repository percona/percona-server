...
In |Percona Server| :rn:`5.1.67-14.4` new statements have been introduced for handling the changed page bitmap tracking. All of these statements require ``SUPER`` privilege.
...
.. variable:: innodb_max_changed_pages
   ...
   :version 5.1.65-14.0: Variable :variable:`innodb_changed_pages_limit` introduced
   :version 5.1.67-14.4: Variable renamed to :variable:`innodb_max_changed_pages`
   :cli: Yes
   :conf: Yes
   :scope: Global
   :dyn: Yes
...
.. variable:: innodb_max_bitmap_file_size
   ...
   :version 5.1.66-14.2: Variable introduced
   :cli: Yes
   :conf: Yes
   :scope: Global
   :dyn: Yes
