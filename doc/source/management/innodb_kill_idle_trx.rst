...
In |Percona Server| :rn:`5.6.35-80.0` this feature has been re-implemented by
...
.. variable:: innodb_kill_idle_transaction
   ...
   :version 5.6.35-80.0: Variable is now an alias of :variable:`kill_idle_transaction`
   :scope: ``GLOBAL``
   :config: ``YES``
   :dyn: ``YES``
   :vartype: ``INTEGER``
...
.. variable:: kill_idle_transaction
   ...
   :version 5.6.35-80.0: Variable implemented
   :scope: ``GLOBAL``
   :config: ``YES``
   :dyn: ``YES``
   :vartype: ``INTEGER``
