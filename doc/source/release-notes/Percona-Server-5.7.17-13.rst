...
Percona is glad to announce the GA (Generally Available) release of **Percona Server for MySQL** 5.7.17-13 on April 5th, 2017 (Downloads are available `here
 ...
 *MyRocks* storage engine detection implemented in ``mysqldump`` in **Percona Server for MySQL** :rn:`5.6.17-12` was using a deprecated
