...
Percona is glad to announce the release of **Percona Server for MySQL** 5.7.27-30 on August 22, 2019. Downloads are available `here <http://www.percona.com/downloads/Percona-Server-5.7/Percona-Server-5.7.27-30/>`_
and from the :doc:`Percona Software Repositories </installation>`.

This release is based on `MySQL 5.7.27 <https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-27.html>`_ and includes all the bug fixes in it. **Percona Server for MySQL** 5.7.27-30 is now the current GA
