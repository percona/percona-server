...
|:Upstream state: Verified (checked on 2017-12-06)                                                            |
...
|:Launchpad bug: :bug:`1266386`                                                                               |
|:Upstream state: Can't repeat (checked on 2017-12-06)                                                        |
|:Fix Released: :rn:`5.5.43-37.2`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Open (checked on 2017-12-06)                                                                |
|:Fix Released: :rn:`5.5.39-36.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
