...
|:Upstream state: Verified (checked on 2016-10-05)                                                            |
|:Fix Released: :rn:`5.5.51-38.1`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Launchpad bug: :bug:`1266386`                                                                               |
|:Upstream state: Can't repeat (checked on 2016-10-05)                                                        |
|:Fix Released: :rn:`5.5.43-37.2`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Open (checked on 2016-10-05)                                                                |
|:Fix Released: :rn:`5.5.39-36.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Verified (checked on 2016-07-01)                                                            |
|:Fix Released: :rn:`5.5.30-30.2`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
