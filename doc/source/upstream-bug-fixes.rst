...
|:Upstream state: Verified (checked on 2014-03-10)                                                            |
...
|:Upstream state: Can't repeat (checked on 2014-03-07)                                                        |
|:Fix Released: :rn:`5.6.16-64.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Verified (checked on 2014-03-07)                                                            |
|:Fix Released: :rn:`5.6.16-64.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Open (checked on 2014-03-07)                                                                |
...
|:Upstream state: No Feedback (checked on 2014-03-07)                                                         |
|:Fix Released: :rn:`5.6.13-61.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
