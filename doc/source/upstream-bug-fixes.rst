...
|:Upstream state: Verified (checked on 2013-10-09)                                                            |
...
|:Upstream state: Need Feedback (checked on 2013-10-09)                                                       |
|:Fix Released: :rn:`5.6.13-61.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Open (checked on 2013-10-09)                                                                |
|:Fix Released: :rn:`5.6.13-61.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: No Feedback (checked on 2013-10-09)                                                         |
|:Fix Released: :rn:`5.6.11-60.3`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Analyzing (checked on 2013-10-09)                                                           |
