...
|:Upstream state: In Progress (checked on 2015-01-12)                                                         |
...
|:Upstream state: Verified (checked on 2015-01-12)                                                            |
|:Fix Released: :rn:`5.6.22-71.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Open (checked on 2015-01-12)                                                                |
|:Fix Released: :rn:`5.6.21-70.1`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: Can't repeat (checked on 2015-01-12)                                                        |
|:Fix Released: :rn:`5.6.16-64.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
...
|:Upstream state: No Feedback (checked on 2015-01-12)                                                         |
|:Fix Released: :rn:`5.6.13-61.0`                                                                             |
|:Upstream fix: N/A                                                                                           |
+-------------------------------------------------------------------------------------------------------------+
