...
#ifndef MYSQL_BINLOG_EVENT_EVENT_READER_MACROS_H
#define MYSQL_BINLOG_EVENT_EVENT_READER_MACROS_H
...
/**
  @} (GroupLibsMysqlBinlogEvent)
*/
#endif  // MYSQL_BINLOG_EVENT_EVENT_READER_MACROS_H
