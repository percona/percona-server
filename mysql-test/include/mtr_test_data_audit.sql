...
-- INSERT INTO mysql.audit_log_filter(name, filter) VALUES ('log_all', '{"filter": { "log": true }}');
-- INSERT INTO mysql.audit_log_user(username, userhost, filtername) VALUES ('root', 'localhost', 'log_all');
