...
EventFieldActionBlock::EventFieldActionBlock(
    std::shared_ptr<event_field_condition::EventFieldConditionBase> condition)
    : m_condition{std::move(condition)} {}

EventActionType EventFieldActionBlock::get_action_type() const noexcept {
  return EventActionType::Block;
}

bool EventFieldActionBlock::apply(const AuditRecordFieldsList &fields,
