...
#ifndef AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_OR_H_INCLUDED
#define AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_OR_H_INCLUDED
...
#endif  // AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_OR_H_INCLUDED
