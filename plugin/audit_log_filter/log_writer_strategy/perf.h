...
#ifndef AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_PERF_H_INCLUDED
#define AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_PERF_H_INCLUDED
...
/**
 * @brief Implements Performance file write strategy - write buffer is used,
 *        messages are dropped in case buffer is full.
 */
template <>
class FileWriterStrategy<AuditLogStrategyType::Performance>
...
using FileWriterStrategyPerformace =
    FileWriterStrategy<AuditLogStrategyType::Performance>;

}  // namespace audit_log_filter::log_writer_strategy

#endif  // AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_PERF_H_INCLUDED
