...
#include "plugin/audit_log_filter/log_writer_strategy/semisync.h"
#include "plugin/audit_log_filter/log_writer/file_handle.h"

namespace audit_log_filter::log_writer_strategy {

bool FileWriterStrategySemisync::do_open_file(
...
bool FileWriterStrategySemisync::do_close_file(
    log_writer::FileHandle *file_handle) noexcept {
  return file_handle->close_file();
}

void FileWriterStrategySemisync::do_write(log_writer::FileHandle *file_handle,
