...
#ifndef AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SEMISYNC_H_INCLUDED
#define AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SEMISYNC_H_INCLUDED
...
/**
 * @brief Implements Semisynchronous file write strategy - no write buffer
 *        is used, uses file system caching.
 */
template <>
class FileWriterStrategy<AuditLogStrategyType::Semisynchronous>
...
using FileWriterStrategySemisync =
    FileWriterStrategy<AuditLogStrategyType::Semisynchronous>;

}  // namespace audit_log_filter::log_writer_strategy

#endif  // AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SEMISYNC_H_INCLUDED
