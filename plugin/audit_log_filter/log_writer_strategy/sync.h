...
#ifndef AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SYNC_H_INCLUDED
#define AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SYNC_H_INCLUDED
...
/**
 * @brief Implements Synchronous file write strategy - no write buffer is used,
 *        data is synced to file.
 */
template <>
class FileWriterStrategy<AuditLogStrategyType::Synchronous>
...
using FileWriterStrategySync =
    FileWriterStrategy<AuditLogStrategyType::Synchronous>;

}  // namespace audit_log_filter::log_writer_strategy

#endif  // AUDIT_LOG_FILTER_LOG_WRITER_STRATEGY_SYNC_H_INCLUDED
