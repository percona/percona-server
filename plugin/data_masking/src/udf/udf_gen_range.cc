...
static bool gen_range_init(UDF_INIT *initid, UDF_ARGS *args, char *message) {
...
static void gen_range_deinit(UDF_INIT *initid) {
...
udf_descriptor udf_gen_range() {
  return {"gen_range", Item_result::INT_RESULT,
          reinterpret_cast<Udf_func_any>(gen_range), gen_range_init,
          gen_range_deinit};
}
