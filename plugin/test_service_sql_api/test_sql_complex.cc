...
static struct st_test_statement test_query_plan[]=
{
  ...
  {NULL  , false, "CREATE DATABASE test1"},
  {NULL  , false, "USE test"},
  {"test1", false, "CREATE TABLE test_inserts("
  ...
  {"test1", false, "INSERT INTO test_inserts VALUES (1, 'one', 1.23, -1, 11.2323, '2014-07-06 07:06:05', '1980-02-19', '-830:12:23',"
                   " 127, 255, 32767, 65535, 8388607, 16777215, 2147483647, 4294967295, 9223372036854775807, 18446744073709551615,"
                   "1901, 999.99, -999.99)"},
  {"test1", false, "INSERT INTO test_inserts VALUES (2, 'two', 2.34, -2, 22.3434, '2015-07-06 21:22:23', '2014-06-05', '356:22:33',"
                   " -128, 0, -32768, 32768, -8388608, 8388607, -2147483648, 0, -9223372036854775808, 18446744073709551615,"
                   "2039, 123.45, -543.21)"},
  {"test1", false, "INSERT INTO test_inserts VALUES (3, 'three',3.45,-3, 33.4545, '2016-09-12 11:12:13', '2013-05-04', '821:33:44',"
