...
#ifndef MYSQLROUTER_REST_CONNECTION_POOL_GLOBAL_STATUS_INCLUDED
#define MYSQLROUTER_REST_CONNECTION_POOL_GLOBAL_STATUS_INCLUDED

#include "mysqlrouter/rest_api_component.h"

class RestConnectionPoolStatus : public RestApiHandler {
 public:
