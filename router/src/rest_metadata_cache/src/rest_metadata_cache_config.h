...
#ifndef MYSQLROUTER_REST_METADATA_CACHE_CONFIG_INCLUDED
#define MYSQLROUTER_REST_METADATA_CACHE_CONFIG_INCLUDED

#include "mysqlrouter/rest_api_component.h"

class RestMetadataCacheConfig : public RestApiHandler {
 public:
  static constexpr const char path_regex[] = "^/metadata/([^/]+)/config/?$";

  RestMetadataCacheConfig(const std::string &require_realm)
