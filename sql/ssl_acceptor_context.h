...
class SslAcceptorContext {
  ...
  */
  static void read_parameters(
      OptionalString *ca = NULL, OptionalString *capath = NULL,
      OptionalString *version = NULL, OptionalString *cert = NULL,
      OptionalString *cipher = NULL, OptionalString *key = NULL,
      OptionalString *crl = NULL, OptionalString *crl_path = NULL);
  ...
  */
  SslAcceptorContext(bool use_ssl_arg, bool report_ssl_error = true,
                     enum enum_ssl_init_error *out_error = NULL);
 ...
 private:
  ...
  SslAcceptorContext(const SslAcceptorContext &);
  /** Disable assignment operator */
  SslAcceptorContext operator=(const SslAcceptorContext);
};
