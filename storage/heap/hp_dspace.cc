...
static uchar *hp_allocate_one_chunk(HP_DATASPACE *info) noexcept;
...
uchar *hp_allocate_chunkset(HP_DATASPACE *info, uint chunk_count) noexcept {
  uchar *result;
...
int hp_reallocate_chunkset(HP_DATASPACE *info, uint chunk_count,
                           uchar *pos) noexcept {
...
void hp_free_chunks(HP_DATASPACE *info, uchar *pos) noexcept {
