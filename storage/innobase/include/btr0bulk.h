...
class PageBulk {
 public:
  ...
  /** Get page no */
  page_no_t getPageNo() { return (m_page_no); }

  /** Get page level */
  ulint getLevel() { return (m_level); }

  /** Get record no */
  ulint getRecNo() { return (m_rec_no); }

  /** Get page */
  page_t *getPage() { return (m_page); }
...
class BtrBulk {
 public:
  ...
  @return error code */
  dberr_t insert(dtuple_t *tuple) { return (insert(tuple, 0)); }
