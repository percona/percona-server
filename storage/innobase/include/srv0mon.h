...
enum monitor_id_t {
  ...
  MONITOR_LRU_AWAIT,
  MONITOR_LRU_AWAIT_RETRY,
  MONITOR_LRU_AWAIT_US,
  MONITOR_LRU_AWAIT_US_PER_CALL,
  MONITOR_LRU_SET_N,
  MONITOR_LRU_SET_WAITERS,
  MONITOR_LRU_SET_WAITERS_PER_CALL,
  MONITOR_LRU_SET_PAGES,
  MONITOR_LRU_SET_PAGES_PER_CALL,
  MONITOR_LRU_BATCH_REQTIME,
  MONITOR_LRU_BATCH_REQTIME_NUM_CALL,
  MONITOR_LRU_BATCH_REQTIME_PER_CALL,
  MONITOR_LRU_BATCH_LIFETIME,
  MONITOR_LRU_BATCH_LIFETIME_NUM_CALL,
  MONITOR_LRU_BATCH_LIFETIME_PER_CALL,
  MONITOR_LRU_PC_MTX_US,
  MONITOR_LRU_PC_MTX_N,
