...
#define BACKUP_WORDS_PER_PAGE 8191
  ...
  typedef LocalDLCFifoList<DeleteLcpFile_pool> LocalDeleteLcpFile_list;
   ...
   */
  struct BackupFile {
    BackupFile(Backup &backup, Page32_pool &pp) : operation(backup), pages(pp) {
      m_retry_count = 0;
    }
...
#define BACKUP_DEFAULT_LOGBUFFER_SIZE (16 * 1024 * 1024)
  ...
  */
  ...
  Uint64 calculate_checkpoint_rate(Uint64 update_size, Uint64 insert_size,
                                   Uint64 delete_size, Uint64 total_memory,
                                   Uint64 &seconds_since_lcp_cut);
  void calculate_redo_parameters(
      Uint64 redo_usage, Uint64 redo_size, Uint64 redo_written_since_last_call,
      Uint64 millis_since_last_call, Uint64 &redo_percentage,
      Uint64 &max_redo_used_before_cut, Uint64 &mean_redo_used_before_cut,
      Uint64 &mean_redo_speed_per_sec, Uint64 &current_redo_speed_per_sec,
...
#define MILLIS_ADJUST_FOR_EARLY_REPORT 20
  ...
  void sendScanFragReq(Signal *, BackupRecordPtr, BackupFilePtr, TablePtr,
                       FragmentPtr, Uint32 delay);
  ...
  */
  ...
  void start_lcp_scan(Signal *signal, BackupRecordPtr ptr, TablePtr tabPtr,
                      Uint32 ptrI, Uint32 fragNo);
