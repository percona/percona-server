...
int T1(void *obj, const SubscriberNumber number, const Location new_location,
  ...
  check = MyOperation->setValue(SUBSCRIBER_LOCATION, (char *)&new_location);
  CHECK_MINUS_ONE(check, "T1: setValue location", MyTransaction);

  check = MyOperation->setValue(SUBSCRIBER_CHANGED_BY, changed_by);
  CHECK_MINUS_ONE(check, "T1: setValue changed_by", MyTransaction);

  check = MyOperation->setValue(SUBSCRIBER_CHANGED_TIME, changed_time);
...
int T2(void *obj, const SubscriberNumber number, Location *readLocation,
  ...
  check2 = MyOperation->getValue(SUBSCRIBER_LOCATION, (char *)readLocation);
  CHECK_NULL(check2, "T2: getValue location", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_CHANGED_BY, changed_by);
  CHECK_NULL(check2, "T2: getValue changed_by", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_CHANGED_TIME, changed_time);
  CHECK_NULL(check2, "T2: getValue changed_time", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_NAME, subscriberName);
...
int T3(void *obj, const SubscriberNumber inNumber,
  ...
  check = MyOperation->equal(SUBSCRIBER_NUMBER, inNumber);
  CHECK_MINUS_ONE(check, "T3-1: equal subscriber", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_LOCATION, (char *)outLocation);
  CHECK_NULL(check2, "T3-1: getValue location", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_CHANGED_BY, outChangedBy);
  CHECK_NULL(check2, "T3-1: getValue changed_by", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_CHANGED_TIME, outChangedTime);
  CHECK_NULL(check2, "T3-1: getValue changed_time", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_GROUP, (char *)&groupId);
  CHECK_NULL(check2, "T3-1: getValue group", MyTransaction);

  check2 = MyOperation->getValue(SUBSCRIBER_SESSIONS, (char *)&sessions);
  ...
  check2 = MyOperation->getValue(GROUP_ALLOW_READ, (char *)&permission);
  ...
  if (((permission & inServerBit) == inServerBit) &&
    ...
    check = MyOperation->equal(SESSION_SUBSCRIBER, (char *)inNumber);
    CHECK_MINUS_ONE(check, "T3-3: equal number", MyTransaction);

    check = MyOperation->equal(SESSION_SERVER, (char *)&inServerId);
    CHECK_MINUS_ONE(check, "T3-3: equal server id", MyTransaction);

    check2 = MyOperation->getValue(SESSION_DATA, (char *)outSessionDetails);
    ...
    check = MyOperation->equal(SERVER_ID, (char *)&inServerId);
    CHECK_MINUS_ONE(check, "T3-4: equal serverId", MyTransaction);

    check = MyOperation->equal(SERVER_SUBSCRIBER_SUFFIX, (char *)inSuffix);
...
int T4(void *obj, const SubscriberNumber inNumber,
  ...
  check2 = MyOperation->getValue(GROUP_ALLOW_INSERT, (char *)&permission);
  ...
  if (((permission & inServerBit) == inServerBit) &&
    ...
    check = MyOperation->equal(SUBSCRIBER_NUMBER, (char *)inNumber);
    CHECK_MINUS_ONE(check, "T4-4: equal number", MyTransaction);

    check = MyOperation->incValue(SUBSCRIBER_SESSIONS, (uint32)inServerBit);
...
int T5(void *obj, const SubscriberNumber inNumber,
  ...
  check2 = MyOperation->getValue(GROUP_ALLOW_DELETE, (char *)&permission);
  ...
  if (((permission & inServerBit) == inServerBit) &&
    ...
    check = MyOperation->subValue(SUBSCRIBER_SESSIONS, (uint32)inServerBit);
