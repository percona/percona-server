...
static struct my_option my_long_options[] = {
    NdbStdOpt::help,
    {"ndb", NDB_OPT_NOSHORT,
     "For command line compatibility with 'perror --ndb', ignored.", nullptr,
     nullptr, nullptr, GET_NO_ARG, NO_ARG, 0, 0, 0, nullptr, 0, nullptr},
    {"silent", 's', "Only print the error message.", &opt_silent, nullptr,
...
static int mgmapi_error_string(int err_no, char *str, int size) {
...
int main(int argc, char **argv) {
  ...
  if (opts.handle_options() != 0) exit(255);
