...
class ha_rocksdb : public my_core::handler {
  ...
  */
  ...
  int get_row_by_rowid(uchar *buf, const char *rowid, const uint rowid_size)
      __attribute__((__nonnull__, __warn_unused_result__));
  int get_row_by_rowid(uchar *buf, const uchar *rowid, const uint rowid_size)
      __attribute__((__nonnull__, __warn_unused_result__)) {
...
public:
  ...
  ulonglong table_flags() const override {
    /*
      ...
      HA_REC_NOT_IN_SEQ
        ...
        1..8 byte numbers
    */
    return HA_BINLOG_ROW_CAPABLE | HA_BINLOG_STMT_CAPABLE | HA_REC_NOT_IN_SEQ |
           HA_CAN_INDEX_BLOBS |
  ...
  */
  ...
  int convert_record_from_storage_format(const rocksdb::Slice *key, uchar *buf)
      __attribute__((__nonnull__, __warn_unused_result__));
  ...
  */
  ...
  rocksdb::Status delete_or_singledelete(uint index, Rdb_transaction *tx,
