...
namespace tokudb {
    ...
    TOKUDB_UNUSED(static uint64_t uint_add(uint64_t x,
                                           uint64_t y,
                                           uint length_bits,
                                           bool* over));
    static uint64_t uint_add(uint64_t x,
                             uint64_t y,
                             uint length_bits,
                             bool* over) {
    ...
    TOKUDB_UNUSED(static uint64_t uint_sub(uint64_t x,
                                           uint64_t y,
                                           uint length_bits,
                                           bool* over));
    static uint64_t uint_sub(uint64_t x,
                             uint64_t y,
                             uint length_bits,
                             bool* over) {
        uint64_t mask = uint_mask(length_bits);
    ...
    // and the overflow.
    TOKUDB_UNUSED(static int64_t int_add(int64_t x,
                                         int64_t y,
                                         uint length_bits,
                                         bool* over));
    ...
    // range, depending on the sign bit. Sign extend to 64 bits. Return the sum
    // and the overflow.
    TOKUDB_UNUSED(static int64_t int_sub(int64_t x,
                                         int64_t y,
                                         uint length_bits,
                                         bool* over));
