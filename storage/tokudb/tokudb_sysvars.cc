...
#define TOKUDB_VERSION_STR NULL
        ...
        static MYSQL_SYSVAR_UINT(cachetable_pool_threads,
        ...
        static MYSQL_SYSVAR_INT(cardinality_scale_percent,
        ...
        static MYSQL_SYSVAR_BOOL(checkpoint_on_flush_logs,
        ...
        static MYSQL_SYSVAR_UINT(checkpoint_pool_threads,
        ...
        static MYSQL_SYSVAR_UINT(checkpointing_period,
        ...
        static MYSQL_SYSVAR_ULONG(cleaner_iterations,
                                  cleaner_iterations,
                                  0,
                                  "cleaner_iterations",
                                  NULL,
        ...
        static MYSQL_SYSVAR_ULONG(cleaner_period,
                                  cleaner_period,
                                  0,
                                  "cleaner_period",
                                  NULL,
        ...
        static MYSQL_SYSVAR_UINT(client_pool_threads,
                                 client_pool_threads,
                                 PLUGIN_VAR_READONLY,
        ...
        static MYSQL_SYSVAR_BOOL(directio,
                                 directio,
                                 PLUGIN_VAR_READONLY,
                                 "enable direct i/o ",
                                 NULL,
        ...
        static MYSQL_SYSVAR_BOOL(enable_partial_eviction,
        ...
        static MYSQL_SYSVAR_UINT(fsync_log_period,
                                 fsync_log_period,
                                 0,
                                 "fsync log period",
                                 NULL,
        ...
        static MYSQL_SYSVAR_STR(log_dir,
                                log_dir,
                                PLUGIN_VAR_READONLY,
                                "log directory",
                                NULL,
        ...
        static MYSQL_SYSVAR_ULONGLONG(max_lock_memory,
                                      max_lock_memory,
                                      PLUGIN_VAR_READONLY,
        ...
        static MYSQL_SYSVAR_BOOL(strip_frm_data,
                                 strip_frm_data,
                                 PLUGIN_VAR_READONLY,
        ...
        static MYSQL_SYSVAR_STR(tmp_dir,
                                tmp_dir,
                                PLUGIN_VAR_READONLY,
        ...
        static MYSQL_SYSVAR_BOOL(dir_per_db,
                                 dir_per_db,
                                 0,
                                 "TokuDB store ft files in db directories",
                                 NULL,
                                 tokudb_dir_per_db_update,
                                 TRUE);
        ...
        static const char* tokudb_empty_scan_names[] = {"disabled",
                                                        "lr",
                                                        "rl",
                                                        NullS};
        ...
        static const char* tokudb_row_format_names[] = {"tokudb_uncompressed",
                                                        "tokudb_zlib",
                                                        "tokudb_snappy",
                                                        "tokudb_quicklz",
                                                        "tokudb_lzma",
        ...
        my_bool bulk_fetch(THD* thd) { return (THDVAR(thd, bulk_fetch) != 0); }
...
#endif  // defined(TOKU_INCLUDE_RFR) && TOKU_INCLUDE_RFR
        my_bool support_xa(THD* thd) { return (THDVAR(thd, support_xa) != 0); }
