...
namespace keyring__vault_parser_unittest
{
  ...
  TEST_F(Vault_parser_test, ParseVaultPayload)
  {
    ...
    EXPECT_FALSE(Vault_base64::encode(key1_signature.c_str(), key1_signature.length(),
                                      &encoded_key1_signature, Vault_base64::SINGLE_LINE));
    Secure_string encoded_key2_signature;
    EXPECT_FALSE(Vault_base64::encode(key2_signature.c_str(), key2_signature.length(),
                                      &encoded_key2_signature, Vault_base64::SINGLE_LINE));

    Secure_string payload("{\"request_id\":\"724a5ad6-7ee3-7950-879a-488a261a03ec\","
  ...
  TEST_F(Vault_parser_test, ParseKeyData)
  {
    ...
    Secure_string payload("{\"request_id\":\"77626d44-edbd-c82f-8220-c3c6b13ef2e1\","
